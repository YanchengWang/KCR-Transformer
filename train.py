...
#     return centroids
def run_kmeans(x, y, num_cluster, min_points_per_centroid=100, niter=60, nredo=5,
               max_points_per_centroid=1500, deviceID=0):
    ...
    clus.niter = niter
    clus.nredo = nredo
    # clus.seed = seed  # Uncomment if you want to set seed for reproducibility
    clus.max_points_per_centroid = max_points_per_centroid
    clus.min_points_per_centroid = min_points_per_centroid
    ...
    D, I = index.search(x, 1)  # Find cluster assignments for each sample
    im2cluster = I.flatten()
    ...
    try:
        for epoch in range(start_epoch, num_epochs):
            ...
            if dist.get_rank() == 0:
                ...
                all_target = all_target.view(-1, 1).numpy()  
